...
A generic class representing a shopping cart that can store SalableProduct objects.
@param <T> the type of SalableProduct to be stored in the shopping cart
*/
        ...
        try {
            ...
            while (scan.hasNext()) {
                ...
                if (parts.length >= 4) {
                    ...
                    T product = (T) new SalableProduct(name, description, price, quantity);
                    productList.add(product);
                } else {
